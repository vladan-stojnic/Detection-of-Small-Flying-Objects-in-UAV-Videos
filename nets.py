from keras.layers import Activation, Conv2D, MaxPooling2D, Input, BatchNormalization, GlobalAveragePooling2D, Dense, UpSampling2D, Add, Conv3D, MaxPooling3D, GlobalAveragePooling3D, Lambda, Concatenate
from keras.models import Model

def BeyondCountingModel(input_shape = (256, 256, 3), out_channels = 1, num_classes = 4):
